...
def test_describe_filter_with_month():
    ...
    desc = _describe_filter(weeks=2, all_events=False, limit=None, 
                           month="+1", week=None, day=None)
...
def test_describe_filter_with_limit():
    ...
    desc = _describe_filter(weeks=2, all_events=False, limit=10,
                           month=None, week=None, day=None)
...
def test_describe_filter_with_all_events():
    ...
    desc = _describe_filter(weeks=2, all_events=True, limit=None,
                           month=None, week=None, day=None)
    assert desc == ""
